...
import { SignatureAlgorithm } from '../client/types.js';
 ...
 */
export interface IkaGrpcTransactionParams {
 ...
 */
export class IkaGrpcTransaction {
	 ...
	 */
	constructor({ ikaClient, transaction, userShareEncryptionKeys }: IkaGrpcTransactionParams) {
